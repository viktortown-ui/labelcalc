...
3. Укажите **main** и папку **/root**.
4. Сохраните настройки и дождитесь публикации.

### Обновление

После каждого пуша в `main` GitHub Pages автоматически обновит сайт.

### Если после обновления не видно изменений

Очистите кэш сайта или данные приложения в настройках браузера, затем перезагрузите страницу.
